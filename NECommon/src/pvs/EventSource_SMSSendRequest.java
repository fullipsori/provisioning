...
public class EventSource_SMSSendRequest extends JavaProcessStarter {
	...
	public static class MyThread implements Runnable {
		...
		public void run() {
			while(true) {
				try {
					this.javaProcessStarter.onEvent(new RequestEvents(Registry.getInstance().takeSMSSendRequest()));
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
